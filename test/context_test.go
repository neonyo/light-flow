...
func TestSearch(t *testing.T) {
	...
	process.CustomStep(invalidUse, "1")
	process.CustomStep(invalidUse, "2", "1")
	process.CustomStep(invalidUse, "3", "1")
	process.CustomStep(getUnExist, "4", "2", "3")
...
func TestRestrictWithSelf(t *testing.T) {
	...
	process.CustomStep(ChangeCtxStepFunc(&ctx1), "0")
	process.CustomStep(ChangeCtxStepFunc(&ctx1), "1")
	process.CustomStep(GenerateStepIncAddr(1), "2", "1")
	process.CustomStep(ChangeCtxStepFunc(&ctx2), "3", "1")
	step := process.CustomStep(GenerateStepIncAddr(1), "4", "2", "3")
	defer func() {
		if r := recover(); r != nil {
			t.Logf("%v", r)
		}
...
func TestPtrReuse(t *testing.T) {
	...
	process1.CustomStep(GenerateStepIncAddr(1), "1")
	process1.CustomStep(GenerateStepIncAddr(2), "2", "1")
	process1.CustomStep(GenerateStepIncAddr(3), "3", "2")
	process1 = workflow.Process("TestPtrReuse2")
	process1.CustomStep(GenerateStepIncAddr(11), "11")
	process1.CustomStep(GenerateStepIncAddr(12), "12", "11")
	process1.CustomStep(GenerateStepIncAddr(13), "13", "12")
...
func TestWaitToDoneInMultiple(t *testing.T) {
	...
	process2.CustomStep(GenerateStepIncAddr(11), "11")
	process2.CustomStep(GenerateStepIncAddr(12), "12", "11")
	process2.CustomStep(GenerateStepIncAddr(13), "13", "12")
	process2.CustomStep(GenerateSleep(100*time.Millisecond), "14", "13")
...
func TestProcessAndWorkflowCtx(t *testing.T) {
	...
	process.AfterStep(true, ErrorResultPrinter)
	process.CustomStep(GenerateStepIncAddr(1), "1")
	process.CustomStep(GenerateStepIncAddr(2), "2", "1")
	process.CustomStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestProcessAndWorkflowCtx2")
	process.AfterStep(true, ErrorResultPrinter)
	process.CustomStep(GenerateStepIncAddr(11), "11")
	process.CustomStep(GenerateStepIncAddr(12), "12", "11")
	process.CustomStep(GenerateStepIncAddr(13), "13", "12")
	workflow.AfterFlow(false, CheckCtxResult(t, 6, flow.Success))
...
func TestStepCtx(t *testing.T) {
	...
	process.CustomStep(ChangeCtxStepFunc(&ctx3), "1")
	process.CustomStep(GenerateStepIncAddr(2), "2", "1")
	process.CustomStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestStepCtx2")
	process.CustomStep(ChangeCtxStepFunc(&ctx4), "11")
	process.CustomStep(GenerateStepIncAddr(12), "12", "11")
	process.CustomStep(GenerateStepIncAddr(13), "13", "12")
	workflow.AfterFlow(false, CheckCtxResult(t, 0, flow.Success))
...
func TestDependStepCtx(t *testing.T) {
	...
	process.AfterStep(true, ErrorResultPrinter)
	process.CustomStep(ChangeCtxStepFunc(&ctx3), "1")
	process.CustomStep(ChangeCtxStepFunc(&ctx5), "2", "1")
	process.CustomStep(GenerateStepIncAddr(3), "3", "2")
	process = workflow.Process("TestDependStepCtx2")
	process.CustomStep(ChangeCtxStepFunc(&ctx4), "11")
	process.CustomStep(ChangeCtxStepFunc(&ctx6), "12", "11")
	process.CustomStep(GenerateStepIncAddr(13), "13", "12")
	workflow.AfterFlow(false, CheckCtxResult(t, 0, flow.Success))
